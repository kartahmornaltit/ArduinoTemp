...
* [Детальные требования](#ДЕТАЛЬНЫЕ-ТРЕБОВАНИЯ)
  ...
  * [Сервер](#СЕРВЕР)
    ...
    * [Функциональные требования](#ФУНКЦИОНАЛЬНЫЕ-ТРЕБОВАНИЯ)
    * [Описание возможностей (пользовательский сценарий)](#ОПИСАНИЕ-ВОЗМОЖНОСТЕЙ-ПОЛЬЗОВАТЕЛЬСКИЙ-СЦЕНАРИЙ)
...
#### ОПИСАНИЕ ВОЗМОЖНОСТЕЙ (ПОЛЬЗОВАТЕЛЬСКИЙ СЦЕНАРИЙ)
* Посещение страницы *Realtime* для просмотра графика температуры в реальном времени;
* Посещение страницы *History*, выбор начальной и конечной даты/времени и просмотр соответствующего графика.
